...
dicio['violão'] = '\nVIOLÃO\nsubstantivo masculino\n1.\nMÚSICA\n'\
                  ...
                  '(da acp. 1) B infrm. diz-se de mulher de formas arredondadas, ancas largas e cintura fina.\n'
...
while True:
    ...
    if continuar.lower() == 'n':
        ...
        if palavra.lower() in dicio:
            ...
            print('\nA palavra ' + palavra + ' não existe no banco de dados.')

print('\nObrigado por ter utilizado o dicionario.\n')
